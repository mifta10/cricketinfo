...
public class DavidWarner extends JFrame {
...
public void initComp() {
 ...
 public void initComp1() {
        ...
        img5= new ImageIcon(getClass().getResource("aus2.jpg"));
 ...
 public void initComp2() {
      ...
      c5.setLayout(null);
        f5=new Font("Arial",Font.ITALIC,20);
         ...
         textlabel1.setText("Name: David Warner");
         ...
         c5.add(textlabel1);
          ...
          textlabel1 = new JLabel();
         textlabel1.setText(" Test:           74              6363        48.2          74.52                  04               4.72          67.25           --                  --             253          45/2");
         textlabel1.setBounds(80,320,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" ODI:          106             4343        43.0           96.55                  00               8.00          ----             --                  --             179           8/0 ");
         textlabel1.setBounds(80,360,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" T20I:           70             1792       26.75           140.11                00                  ----          ----             --                  --             90              ----");
   ...
   public void initComp3()
    ...
    {
    DavidWarner  frame5=new DavidWarner ();
