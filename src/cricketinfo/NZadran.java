...
public class NZadran extends JFrame {
...
public void initComp() {
 ...
 public void initComp1() {
        ...
        img5= new ImageIcon(getClass().getResource("afg6.jpg"));
 ...
 public void initComp2() {
      ...
      c5.setLayout(null);
        f5=new Font("Arial",Font.ITALIC,20);
         ...
         textlabel1.setText("Name: Najibullah Zadran");
         ...
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" ODI:           50             1077        26.9           86.3                  --                     ---          ---             --                  --              89            --/-");
         textlabel1.setBounds(80,360,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" T20I:           47              711        29.6           143.4                --                     ---          ---             --                  --             60              --/-");
