...
public class AdamZampa extends JFrame {
...
public void initComp() {
 ...
 public void initComp1() {
        ...
        img5= new ImageIcon(getClass().getResource("aus16.jpg"));
 ...
 public void initComp2() {
      ...
      c5.setLayout(null);
        f5=new Font("Arial",Font.ITALIC,20);
         ...
         textlabel1.setText("Name: Adam Zampa");
         ...
         c5.add(textlabel1);
          ...
          textlabel1 = new JLabel();
         textlabel1.setText(" Test:           64               199        61.4           55.5                  17               4.18          54.9             --                  --             239          83/4");
         textlabel1.setBounds(80,320,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" ODI:          108              1021        41.8           86.3                  27               5.34          34.5             --                  --             164          16/3");
   ...
   public void initComp3()
    ...
    {
    AdamZampa  frame5=new AdamZampa ();
