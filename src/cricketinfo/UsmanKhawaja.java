...
public class UsmanKhawaja extends JFrame {
...
public void initComp() {
 ...
 public void initComp1() {
        ...
        img5= new ImageIcon(getClass().getResource("aus6.jpg"));
 ...
 public void initComp2() {
      ...
      c5.setLayout(null);
        f5=new Font("Arial",Font.ITALIC,20);
         ...
         textlabel1.setText("Name: Usman Khawaja");
         ...
         c5.add(textlabel1);
          ...
          textlabel1 = new JLabel();
         textlabel1.setText(" Test:           35              2455        43.8           51.5                  00               1             ---             --                  --             174           1/0");
         textlabel1.setBounds(80,320,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" ODI:          18              469         31.27           82.28                  --               ----          ----             --                  --             98           ----");
         textlabel1.setBounds(80,360,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" T20I:           9               241        26.78           132.42                --               ----          ----             --                  --             58              ----");
   ...
   public void initComp3()
    ...
    {
    UsmanKhawaja  frame5=new UsmanKhawaja ();
