...
public class JoshHazlewood extends JFrame {
...
public void initComp() {
 ...
 public void initComp1() {
        ...
        img5= new ImageIcon(getClass().getResource("aus14.jpg"));
 ...
 public void initComp2() {
      ...
      c5.setLayout(null);
        f5=new Font("Arial",Font.ITALIC,20);
         ...
         textlabel1.setText("Name: Josh Hazlewood");
         ...
         c5.add(textlabel1);
          ...
          textlabel1 = new JLabel();
         textlabel1.setText(" Test:           40               337        61.4           55.5                  95               4.18          54.9             --                  --              39          83/4");
         textlabel1.setBounds(80,320,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" ODI:           44               37        41.8           86.3                  33               5.34          34.5             --                  --              11          16/3");
         textlabel1.setBounds(80,360,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" T20I:            7                         21.6           122.4                10               7.77          22.2             --                  --             00              20/3");
   ...
   public void initComp3()
    ...
    {
    JoshHazlewood  frame5=new JoshHazlewood ();
