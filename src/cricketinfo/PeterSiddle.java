...
public class PeterSiddle extends JFrame {
...
public void initComp() {
 ...
 public void initComp1() {
        ...
        img5= new ImageIcon(getClass().getResource("aus13.jpg"));
 ...
 public void initComp2() {
      ...
      c5.setLayout(null);
        f5=new Font("Arial",Font.ITALIC,20);
         ...
         textlabel1.setText("Name: Peter Siddle");
         ...
         c5.add(textlabel1);
          ...
          textlabel1 = new JLabel();
         textlabel1.setText(" Test:           64              1080        14.2           47.0                  280               4.18          54.9             --                  --              51         90/8");
         textlabel1.setBounds(80,320,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" ODI:           17               21        10.5           116.6                  20               5.34          34.5             --                  --               9          16/3");
         textlabel1.setBounds(80,360,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" T20I:           2                1                           100.0                   2               7.77          22.2             --                  --              1              20/1");
   ...
   public void initComp3()
    ...
    {
    PeterSiddle  frame5=new PeterSiddle ();
