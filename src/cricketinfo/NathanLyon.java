...
public class NathanLyon extends JFrame {
...
public void initComp() {
 ...
 public void initComp1() {
        ...
        img5= new ImageIcon(getClass().getResource("aus11.jpg"));
 ...
 public void initComp2() {
      ...
      c5.setLayout(null);
        f5=new Font("Arial",Font.ITALIC,20);
         ...
         textlabel1.setText("Name: Nathan Lyon");
         ...
         c5.add(textlabel1);
          ...
          textlabel1 = new JLabel();
         textlabel1.setText(" Test:           80               839        11.6           45.8                  318               3.06          32.2             --                  --              47         154/13");
         textlabel1.setBounds(80,320,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" ODI:           15               50         16.6           45.8                  18               4.83          36.7             --                  --              30          44/4");
         textlabel1.setBounds(80,360,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" T20I:           2                  4                        100.0                   01               9.6          48.0             --                  --              4              33/1");
   ...
   public void initComp3()
    ...
    {
    NathanLyon  frame5=new NathanLyon ();
