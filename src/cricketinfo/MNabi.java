...
public class MNabi extends JFrame {
...
public void initComp() {
 ...
 public void initComp1() {
        ...
        img5= new ImageIcon(getClass().getResource("afg1.jpg"));
 ...
 public void initComp2() {
      ...
      c5.setLayout(null);
        f5=new Font("Arial",Font.ITALIC,20);
         ...
         textlabel1.setText("Name: Mohammad Nabi");
         ...
         c5.add(textlabel1);
          ...
          textlabel1 = new JLabel();
         textlabel1.setText(" Test:           01                24        12.0           50.0                  01               5.00          65.0             --                  --              24          65/1");
         textlabel1.setBounds(80,320,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" ODI:          106             2449        28.5           88.0               114               4.25          31.5             --                  --             116          30/4");
         textlabel1.setBounds(80,360,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" T20I:           64              984        19.7           141.6                67               7.20          24.2             --                  --             89              10/4");
