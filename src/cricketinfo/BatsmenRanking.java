...
public class BatsmenRanking extends JFrame
{
     ...
     public void init() {
      ...
      c1.setLayout(null);
        f1=new Font("Arial",Font.ITALIC,30);
         ...
         textlabel1.setBounds(200,70,400,100);
      ...
      public void init2(){
         ...
         submitbt.setBounds(860,450,80,30);
         c1.add(submitbt);
       ...
       public void init9()
      {
            backbt=new JButton();
         backbt.setText("Back");
         backbt.setBounds(120,450,80,30);
         c1.add(backbt);
       ...
       public void init10() {
        ...
        img = new ImageIcon(getClass().getResource("Te_1.jpg"));
    ...
    public static void main(String[] args) {
        ...
        BatsmenRanking frame2 = new BatsmenRanking();
        

        frame2.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        frame2.setBounds(0,0,1380,730);
