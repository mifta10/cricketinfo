...
public class AaronFinch extends JFrame {
...
public void initComp() {
 ...
 public void initComp1() {
        ...
        img5= new ImageIcon(getClass().getResource("aus9.jpg"));
 ...
 public void initComp2() {
      ...
      c5.setLayout(null);
        f5=new Font("Arial",Font.ITALIC,20);
         ...
         textlabel1.setText("Name: Aaron Finch");
         ...
         c5.add(textlabel1);
          ...
          textlabel1 = new JLabel();
         textlabel1.setText(" Test:           02              181         45.2           44.8                  --                   ---             ---             --                  --              64           ---");
         textlabel1.setBounds(80,320,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" ODI:          96              3418        37.56           89.5                  02               5.20          68.5             --                  --             148          02/1");
         textlabel1.setBounds(80,360,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" T20I:           48             1635        39.9          157.21                00               ---              ----             --                  --              172            9/0");
   ...
   public void initComp3()
    ...
    {
    AaronFinch  frame5=new AaronFinch ();
