...
public class MitchStarc extends JFrame {
...
public void initComp() {
 ...
 public void initComp1() {
        ...
        img5= new ImageIcon(getClass().getResource("aus3.jpg"));
 ...
 public void initComp2() {
      ...
      c5.setLayout(null);
        f5=new Font("Arial",Font.ITALIC,20);
         ...
         textlabel1.setText("Name: Mitchel Starc");
         ...
         c5.add(textlabel1);
          ...
          textlabel1 = new JLabel();
         textlabel1.setText(" Test:           45              1234        21.28          68.03             186               3.4         28.52             --                  --              99             94/11");
         textlabel1.setBounds(80,320,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" ODI:           75              280        12.73          89.46              145               4.96         21.45             --                  --              52             28/6");
         textlabel1.setBounds(80,360,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" T20I:           22              006        3.00           66.67                30               6.78         18.87             --                  --             04              11/3");
   ...
   public void initComp3()
    ...
    {
    MitchStarc  frame5=new MitchStarc ();
