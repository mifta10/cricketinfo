...
public class TeamRanking extends JFrame
{
     ...
     public void init() {
      ...
      c1.setLayout(null);
        f1=new Font("Arial",Font.ITALIC,30);
         ...
         textlabel1.setBounds(250,50,300,100);
       ...
       public void init9()
      {
            backbt=new JButton();
         backbt.setText("Back");
         backbt.setBounds(100,450,80,30);
         c1.add(backbt);
        ...
        img = new ImageIcon(getClass().getResource("h5.jpg"));
    ...
    public static void main(String[] args) {
        ...
        TeamRanking frame2 = new TeamRanking();
