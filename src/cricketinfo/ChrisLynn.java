...
public class ChrisLynn extends JFrame {
...
public void initComp() {
 ...
 public void initComp1() {
        ...
        img5= new ImageIcon(getClass().getResource("aus4.jpg"));
 ...
 public void initComp2() {
      ...
      c5.setLayout(null);
        f5=new Font("Arial",Font.ITALIC,20);
         ...
         textlabel1.setText("Name: Chris Lynn");
         ...
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" ODI:          004              75        18.75            84.27                 --               ---          ---               --                    --              44          ---");
         textlabel1.setBounds(80,360,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" T20I:           16              265        20.38           133.84                --               ---          ---             --                    --             44              ---");
   ...
   public void initComp3()
    ...
    {
    ChrisLynn  frame5=new ChrisLynn ();
