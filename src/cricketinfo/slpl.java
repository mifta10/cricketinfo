...
public class slpl extends JFrame {
    ...
    public void initComponents()
    {
     ...
     public void initComponents2() {
         ...
         bt5=new JButton();
         bt5.setText("Mahela Jayawardene");
         ...
         bt12.addActionListener(new ActionListener() {
          ...
          bt13=new JButton();
         bt13.setText("Dhananjaya de Silva");
         ...
         bt14.addActionListener(new ActionListener() {
          ...
          bt15=new JButton();
         bt15.setText("Dimuth Karunaratne");
         ...
         bt15.addActionListener(new ActionListener() {
             ...
             public void actionPerformed(ActionEvent e) {
                 dispose();
                Karunaratne f1=new Karunaratne();
                f1.setVisible(true);
                f1.setExtendedState(JFrame.MAXIMIZED_BOTH);
          ...
          bt16=new JButton();
         bt16.setText("Chamara Kapugedara");
