...
public class GlennMaxwell extends JFrame {
...
public void initComp() {
 ...
 public void initComp1() {
        ...
        img5= new ImageIcon(getClass().getResource("aus5.jpg"));
 ...
 public void initComp2() {
      ...
      c5.setLayout(null);
        f5=new Font("Arial",Font.ITALIC,20);
         ...
         textlabel1.setText("Name: Glenn Maxwell");
         ...
         c5.add(textlabel1);
          ...
          textlabel1 = new JLabel();
         textlabel1.setText(" Test:           07              339         26.0           59.4                  08               4.43          42.6             --                  --             104         127/4");
         textlabel1.setBounds(80,320,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" ODI:          87              2242        32.0           121.0                  45               5.59          40.98           --                  --             102          46/4");
         textlabel1.setBounds(80,360,1380,120);
         textlabel1.setFont(f5);
         c5.add(textlabel1);
          textlabel1 = new JLabel();
         textlabel1.setText(" T20I:           55              1313        32.0           159.9                25               7.54          27.1             --                  --             145           10/3");
   ...
   public void initComp3()
    ...
    {
    GlennMaxwell  frame5=new GlennMaxwell ();
