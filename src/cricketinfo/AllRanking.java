...
public class AllRanking extends JFrame
{
     ...
     public void init() {
      ...
      c1.setLayout(null);
        f1=new Font("Arial",Font.BOLD,30);
         ...
         textlabel1.setBounds(380,50,380,100);
      ...
      public void init2(){
         ...
         submitbt.setBounds(850,450,80,30);
         c1.add(submitbt);
       ...
       public void init9()
      {
        ...
        img = new ImageIcon(getClass().getResource("allr.jpg"));
    ...
    public static void main(String[] args) {
       ...
       AllRanking frame2 = new AllRanking();
